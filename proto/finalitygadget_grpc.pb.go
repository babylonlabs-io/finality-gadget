...
const (
	...
	FinalityGadget_QueryIsBlockBabylonFinalizedFromBabylon_FullMethodName = "/proto.FinalityGadget/QueryIsBlockBabylonFinalizedFromBabylon"
...
type FinalityGadgetClient interface {
	...
	QueryIsBlockBabylonFinalizedFromBabylon(ctx context.Context, in *QueryIsBlockBabylonFinalizedRequest, opts ...grpc.CallOption) (*QueryIsBlockFinalizedResponse, error)
...
func (c *finalityGadgetClient) QueryIsBlockBabylonFinalizedFromBabylon(ctx context.Context, in *QueryIsBlockBabylonFinalizedRequest, opts ...grpc.CallOption) (*QueryIsBlockFinalizedResponse, error) {
	out := new(QueryIsBlockFinalizedResponse)
	err := c.cc.Invoke(ctx, FinalityGadget_QueryIsBlockBabylonFinalizedFromBabylon_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FinalityGadgetServer interface {
	...
	// QueryIsBlockBabylonFinalizedFromBabylon returns the finality status of a block by
	// querying Babylon chain directly
	QueryIsBlockBabylonFinalizedFromBabylon(context.Context, *QueryIsBlockBabylonFinalizedRequest) (*QueryIsBlockFinalizedResponse, error)
	// QueryBlockRangeBabylonFinalized returns the last finalized block height
	// within a block range by querying Babylon chain
...
func (UnimplementedFinalityGadgetServer) QueryIsBlockBabylonFinalizedFromBabylon(context.Context, *QueryIsBlockBabylonFinalizedRequest) (*QueryIsBlockFinalizedResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method QueryIsBlockBabylonFinalizedFromBabylon not implemented")
}
...
func _FinalityGadget_QueryIsBlockBabylonFinalizedFromBabylon_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryIsBlockBabylonFinalizedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FinalityGadgetServer).QueryIsBlockBabylonFinalizedFromBabylon(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FinalityGadget_QueryIsBlockBabylonFinalizedFromBabylon_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FinalityGadgetServer).QueryIsBlockBabylonFinalizedFromBabylon(ctx, req.(*QueryIsBlockBabylonFinalizedRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FinalityGadget_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "QueryIsBlockBabylonFinalizedFromBabylon",
			Handler:    _FinalityGadget_QueryIsBlockBabylonFinalizedFromBabylon_Handler,
		},
		{
